...
#        self.placeReplicasInCloud(child)
    ...
    def replicaGrowth(self,child):
        self.replicaIncreseValue(child,1,self.system.fogNumber/10)
...
#******************************************************************************************
    ...
    def crossover(self,f1,f2,offs):
        ...
        return self.crossoverMIO(f1,f2,offs)
...
#******************************************************************************************
    ...
    def notEnoughResourceFogDevice(self,chromosome,fogId):
...
#            return True
    ...
    def notEnoughResource(self,chromosome):
        ...
        for fogId in range(0,self.system.fogNumber):
            if self.notEnoughResourceFogDevice(chromosome,fogId):
                return True
